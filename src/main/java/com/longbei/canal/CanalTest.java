...
public class CanalTest {
    ...
    private static void initConnector(String destination) {
        CanalConnector connector = CanalConnectors.newClusterConnector("192.168.1.18:2181,192.168.1.19:2181,192.168.1.20:2181",destination, "", "");
        //CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("192.168.1.21", 11111), destination, "", "");
        try {
            connector.connect();
            connector.subscribe(".*\\..*");  //订阅所有库下面所有表
